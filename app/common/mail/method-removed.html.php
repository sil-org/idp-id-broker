 ...
 * @var string $alternateAddress   Recovery email address removed. Generated at runtime.
...
<p>
    The email address <?= yHtml::encode($alternateAddress) ?> was removed as a password recovery method from the
    <?= yHtml::encode($idpDisplayName) ?> Identity account belonging to
    <?= yHtml::encode($displayName) ?> (<?= yHtml::encode($username) ?>).
</p>
<p>
    That address can no longer be used to reset the password for that account.
</p>
<p>
